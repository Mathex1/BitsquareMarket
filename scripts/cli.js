...
const contractABI = require("../artifacts/contracts/Bitsquaremarket.sol/Bitsquaremarket.json").abi;

program
    .name("bitsquaremarket-cli")
    .description("CLI tool for Bitsquaremarket smart contract")
    .version("1.0.0");
